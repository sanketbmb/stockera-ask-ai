...
// as educational / other. These intents don't yet have a shipped Brain flow,
// so we render a holding panel instead of letting the /report/$queryId
// loader spin forever.
//
// Phase 3B — sector_view was removed from this panel's responsibility; it
// now renders via <SectorViewReport />. Keep the label mapping for legacy
// rows but the dispatcher won't route sector_view here.
      ...
      <main className="px-4 sm:px-6 lg:px-8 py-10 print:py-0">
        <div className="mx-auto max-w-2xl space-y-6">
          ...
          <p className="text-[11px] text-muted-foreground text-center">
            AI report generation for Educational topics is coming soon.
          </p>
        </div>
      </main>
    </div>
