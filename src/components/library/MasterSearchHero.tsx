          ...
          <div className="mt-4 flex flex-wrap items-center justify-center gap-2">
            {CHIPS.map((c) => (
              <button
                ...
                type="button"
                onClick={() => setSeed(c)}
                className="rounded-full border border-border bg-card px-3 py-1 text-xs text-muted-foreground transition-all duration-200 hover:-translate-y-0.5 hover:border-primary/40 hover:text-foreground hover:shadow-sm"
              >
