    ...
    <div className="min-h-screen bg-mesh">
      ...
      <main className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 py-8">
        <header className="mb-6 flex items-center justify-between flex-wrap gap-4">
          <div>
            <p className="font-mono text-xs uppercase tracking-widest text-accent">Your Holdings</p>
            <h1 className="font-display text-3xl md:text-4xl mt-1 flex items-center gap-3">
              <Briefcase className="h-8 w-8 text-primary" /> Portfolio
            </h1>
        ...
        {isLoading ? (
          ...
          <Card className="p-12 text-center">
            ...
            <h3 className="font-display text-2xl">Your portfolio is empty</h3>
            <p className="text-sm text-muted-foreground mt-2 max-w-md mx-auto">
              Post a query, get an AI report, then tap "Add to my Portfolio" to start tracking with target / stop-loss alerts.
            </p>
