...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Ask The Expert by Stockera — SEBI-Registered Research Analyst" },
      { name: "description", content: "India's first AI + Expert stock query platform. Get SEBI-registered analyst verdicts on Indian equities. AI grounds the answer in real NSE/BSE data; a SEBI-registered analyst records your personalized video answer within 24 hours." },
      { name: "robots", content: "index,follow" },
      { property: "og:title", content: "Ask The Expert by Stockera — SEBI-Registered Research Analyst" },
      { property: "og:description", content: "India's first AI + Expert stock query platform. Get SEBI-registered analyst verdicts on Indian equities." },
      ...
      { name: "twitter:description", content: "SEBI-registered analyst verdicts on Indian stocks. AI + Expert in one platform." },
